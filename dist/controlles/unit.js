...
class Unit {
    ...
    updateUnit(req, res, next) {
        (0, ApiError_1.catchError)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!teacher)
                next(new ApiError_1.AppError('this unit not found', 404));
    ...
    getunits(req, res, next) {
        (0, ApiError_1.catchError)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            console.log(id);
            const units = yield unitsModel_1.default.find({ subject_id: id }).populate('lessons');
            if (!units.length)
                next(new ApiError_1.AppError('no units found', 404));
